...
<body>
	<div align='center'>
	<div style='margin-top:50px; border:none; width:630px; padding-left:0px; margin-left:0px'>
	<div style='width:420px; text-align:left;'><?php echo $html->link($html->image('logo.png'), '#', array('escape'=>false)); ?></div>
